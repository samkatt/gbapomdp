...
coverage: ## check code coverage quickly with the default Python
	coverage run --source general_bayes_adaptive_pomdps -m pytest
	coverage report -m
	coverage html
	$(BROWSER) htmlcov/index.html

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/general_bayes_adaptive_pomdps.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ general_bayes_adaptive_pomdps
	$(MAKE) -C docs clean
	$(MAKE) -C docs html

docs-open: docs ## generate Sphinx HTML documentation, including API docs
