...
class Tiger3(domain.Domain):
    ...
    # In this part, we have three doors, so we will add one extra element "Mid" towards it
    ...
    def __init__(
        ...
        """
        # supposes the correct observation probabilties are all 0.85
        ...
        # when open left and right door, no observation, it can be seen from the simulation and sample part
        # the observation should consists of 0, 1, 2 and null, which means the discrete space size is 4
    ...
    # 观察到index
    # I add print function and see the observation are single elemnt 0, 1 and 2
    # so the state
