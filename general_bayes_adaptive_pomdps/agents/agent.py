...
class Agent(abc.ABC):
    ...
    @abc.abstractmethod
    def update(self, observation: np.ndarray, reward: float, terminal: bool):
...
class RandomAgent(Agent):
    ...
    def __init__(self, action_space: ActionSpace):
        ...
        Args:
             num_actions: (`general_bayes_adaptive_pomdps.environments.ActionSpace`): the action space
    ...
    def episode_reset(self, observation: np.ndarray) -> None:
        ...
        Part of the interface of `general_bayes_adaptive_pomdps.agents.agent.Agent`
