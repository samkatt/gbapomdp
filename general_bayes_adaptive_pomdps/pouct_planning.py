...
from general_bayes_adaptive_pomdps.domains import create_environment, EncodeType
...
def parse_arguments(args: Optional[List[str]] = None):
    ...
    parser.add_argument(
        ...
        required=True,
        choices=["tiger", "gridworld", "collision_avoidance", "chain", "road_racer"],
    )
