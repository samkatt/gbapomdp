...
def test_create_model_updates(backprop, replay, perturb, len_output):
    """Tests :func:`create_model_updates`"""
    assert (
        len(
            create_model_updates(
