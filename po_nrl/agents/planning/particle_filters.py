...
from po_nrl.domains.learned_environments import BADDr
...
def create_importance_sampling(sim: BADDr, num_samples: int):
    """Creates importance sampling :class:`po_nrl.agents.planning.belief.BeliefUpdate`
    ...
    Returns:
        po_nrl.agents.planning.belief.BeliefUpdate: a way of updating the belief
    """
...
def create_rejection_sampling(sim: Simulator, num_samples: int):
    """Creates rejection sampling :class:`po_nrl.agents.planning.belief.BeliefUpdate`
...
def create_belief_update(conf, sim: Simulator):
    """Factory function for :class:`po_nrl.agents.planning.belief.BeliefUpdate`
    ...
    Returns:
        po_nrl.agents.planning.belief.BeliefUpdate
